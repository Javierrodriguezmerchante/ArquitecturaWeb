<%-- 
    Document   : Gestion_billetes_consultar
    Created on : 30-dic-2017, 17:12:14
    Author     : javier
--%>
		...
		<!-- Wrapper -->
			<div id="wrapper">
				...
				<!-- Menu -->
					...
					<div id="main">
						<div class="inner">
							<h1>Aqui podras ver todas los billetes existentes</h1>
											...
											<tbody>
                                                                                            <%--
                                                                                                ...
                                                                                                for(int i=0; i<lista.size();i++)
                                                                                                {
                                                                                                    ...
                                                                                                    out.println("<td>"+lista.get(i).getSerie()+"</td>");
