<%-- 
    Document   : no_existe
    Created on : 02-ene-2018, 20:43:45
    Author     : javier
--%>
		...
		<!-- Wrapper -->
			<div id="wrapper">
				...
				<!-- Menu -->
					...
					<div id="main">
						<div class="inner">
							<h1 align="center">OOHH!! ALGO HA IDO MAL</h1>
                                                                <section>
									<h2 align="center">Lo sentimos, pero el elemento al que intenta acceder no existe</h2>
                                                                        <div align="center"><img style="vertical-align:middle" src="images/error.png" alt="" /></div>
