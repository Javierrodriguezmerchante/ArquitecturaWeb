				...
				<!-- Menu -->
					...
					<div id="main">
						<div class="inner">
							...
							<dip>En este apartado podran insertarse todo tipo de billetes entre las fechas 1939 y 1975, en las que tiene lugar los fundamentos idelológicos, solciales y políticos del franquismo. En cuya época aumentaron las dificultades de aprovisionamiento de billetes, que llevo al gobierno a crear una dabrica de billetes con capital privado</p>
